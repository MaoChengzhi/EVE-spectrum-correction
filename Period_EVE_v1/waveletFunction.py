...
def wavelet(Y, dt, pad=1, dj=-1, s0=-1, J1=-1, mother=-1, param=-1, **kwargs):
    n1 = len(Y)
...
def wave_bases(mother, k, scale, param, **kwargs):
    n = len(k)
...
def wave_signif(Y, dt, scale, sigtest=0, lag1=0.0, siglvl=0.95,
    dof=None, mother='MORLET', param=None, gws=None, **kwargs):

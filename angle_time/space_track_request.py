...
#
# =============================================================================
configUsr = "maochengzhi1@gmail.com"
configPwd = "R*G_JLNT78U!6hv"
configOut = "output.xlsx"
siteCred = {'identity': configUsr, 'password': configPwd}
# %%
...
with requests.Session() as session:
    ...
    for s in satIds:
        ...
        for e in retData:
            ...
            print("Scanning satellite " +
                  e['OBJECT_NAME'] + " at epoch " + e['EPOCH'])
            ...
            worksheet.write(wsline, 11, float(
                e['ARG_OF_PERICENTER']), z1_format)

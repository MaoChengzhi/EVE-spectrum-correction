...
aia_filename = "../data/AIA/aia_lev1_304a_2011_02_03t00_00_08_12z_image_lev1_adjusted.fits"

aia_adjusted_map = sunpy.map.Map(aia_filename)

image_data = aia_adjusted_map.data
image_shape_x, image_shape_y = aia_adjusted_map.data.shape

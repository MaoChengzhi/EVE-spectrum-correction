...
np.savez("output_DN/_2048/DN_2048_IDL_large_lambda_range.npz",
         DN_alpha=DN_alpha)
end = time.time()
...
# %%
# np.savez("output_DN/_4096/DN_4096.npz", DN_alpha=DN_alpha, DN_beta=DN_beta)
# np.savez("output_DN/_4096/DN_4096.npz", DN_alpha=DN_alpha)
# np.savez("output_DN/_4096/DN_beta_4096.npz", DN_beta=DN_beta)

# Process=12, run for 1h on Feb 14th    4096
# March 8 th    2048  10min

# %%
# np.savez("output_DN/_2048/DN_2048.npz", DN_alpha=DN_alpha, DN_beta=DN_beta)
